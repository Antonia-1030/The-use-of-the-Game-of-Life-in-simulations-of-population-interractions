...
namespace Gol
{
    public partial class GOL : Form
    {
        ...
        public int[,] CurrentGen = new int[30,30];
        ...
        //currently spawns all different cell types
        public void blueSpawn()
        {
            for (int i = 0; i < maxX; i++)
            {
                for (int j = 0; j < maxY; j++)
                {
                    ...
                    else if (CurrentGen[i, j] == 1 && redNeighbors >= 2)
                        NextGen[i, j] = 0;
                    ...
                    else if (CurrentGen[i, j] == 2 && greenNeighbors >= 3)
                        NextGen[i, j] = 4;
                    //yellow cell
                        ...
                        NextGen[i, j] = 0;
                    //green cell
                    else if (CurrentGen[i, j] == 4 && greenNeighbors < 2 && isGreenBreeding==true)
                        NextGen[i, j] = 0;

                    else if (CurrentGen[i, j] == 4 && greenNeighbors > 3 && isGreenBreeding==true)
                        NextGen[i, j] = 0;

                    else if (CurrentGen[i, j] == 0 && greenNeighbors >= 3 && isGreenBreeding==true)
                        NextGen[i, j] = 4;
        ...
        //commented previous versions of the spawning code
        ...
        {
            isGreenBreeding = true;
        }

        private void buttonN_Click(object sender, EventArgs e)
        {
            isGreenBreeding = false;
        }

        private void getArrayFromTxt(object sender, EventArgs e)
        {
            string path = @"D:\Desktop\DIPLOMNA !!!\GolAR.txt";
